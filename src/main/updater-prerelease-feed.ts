...
const ATOM_FEED_URL = 'https://github.com/houlemon0130/orca/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/houlemon0130/orca/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/houlemon0130\/orca\/releases\/tag\/([^"]+)"/g
